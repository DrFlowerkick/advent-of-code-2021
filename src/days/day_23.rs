...
pub fn solution() -> Result<()> {
    ...
    let input = include_str!("../../assets/day_23_part2.txt");
    let challenge = ChallengeInput::from(input);
...
mod tests {
    ...
    fn test_steps_of_example() {
        let input = include_str!("../../assets/day_23_example_steps.txt");
    ...
    fn test_example_day_23() -> Result<()> {
        ...
        let input = include_str!("../../assets/day_23_example_part2.txt");
        let example = ChallengeInput::from(input);
